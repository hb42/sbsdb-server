...
CREATE TABLE sbsdb_master.adresse (
    id        NUMBER(19)
        GENERATED BY DEFAULT AS IDENTITY ( START WITH 200000 NOCACHE ORDER )
...
ALTER TABLE sbsdb_master.extprog
    ADD CONSTRAINT extprog_apkategorie_fk FOREIGN KEY ( apkategorie_id )
        REFERENCES sbsdb_master.apkategorie ( id )
    NOT DEFERRABLE;
