...
//    @ManyToOne(type=>SBS_OE, SBS_OE=>SBS_OE.sBS_OEs,{  nullable:false,onDelete: 'RESTRICT',onUpdate: 'RESTRICT' })
...
//    @OneToMany(type=>SBS_OE, SBS_OE=>SBS_OE.pARENT_OE,{ onDelete: 'RESTRICT' ,onUpdate: 'RESTRICT' })
//    sBS_OEs:SBS_OE[];
