...
namespace hb.SbsdbServer.sbsdbv4.model {
    ...
    public class SbsSw {
        ...
        [Column("LIZENZ_PA")] public double? LizenzPa { get; set; }
        ...
        [InverseProperty("SwIndexNavigation")] public virtual ICollection<SbsApSw> SbsApSw { get; set; }

        [InverseProperty("SwIndexNavigation")] public virtual ICollection<SbsSwBestand> SbsSwBestand { get; set; }

        [InverseProperty("SwIndexNavigation")] public virtual ICollection<SbsSwOpdv> SbsSwOpdv { get; set; }

        [InverseProperty("SwIndexNavigation")] public virtual ICollection<SbsSwVv> SbsSwVv { get; set; }
    }
}
