...
namespace hb.SbsdbServer.sbsdbv4.model {
    ...
    public class SbsAp {
        ...
        [InverseProperty("ApIndexNavigation")] public virtual ICollection<SbsApAdr> SbsApAdr { get; set; }

        [InverseProperty("ApIndexNavigation")] public virtual ICollection<SbsApSw> SbsApSw { get; set; }

        [InverseProperty("ApIndexNavigation")] public virtual ICollection<SbsHw> SbsHw { get; set; }

        [InverseProperty("ApIndexNavigation")] public virtual ICollection<SbsTtIssue> SbsTtIssue { get; set; }
    }
}
