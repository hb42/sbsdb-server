...
namespace hb.SbsdbServer.sbsdbv4.model {
    ...
    public class SbsOe {
        ...
        [InverseProperty("OeIndexNavigation")] public virtual ICollection<SbsAp> SbsApOeIndexNavigation { get; set; }

        [InverseProperty("StandortIndexNavigation")]
        public virtual ICollection<SbsAp> SbsApStandortIndexNavigation { get; set; }

        [InverseProperty("OeIndexNavigation")] public virtual ICollection<SbsSw> SbsSw { get; set; }
    }
}
